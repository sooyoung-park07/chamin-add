...
GROUP = "tb_naver_slope"
CAND_KEYS = F.TB_NAVER_SLOPE_KEYS
ARMS = [("L0 base(54)", []), (f"TB4d +naver_slope({54 + len(CAND_KEYS)})", CAND_KEYS)]
CANDIDATE = ARMS[1][0]
OUT = os.path.join(C.EXPERIMENTS, "phase_tb4d_naver_slope.json")
