# -*- coding: utf-8 -*-
"""Tier B — TB8: "화담숲 단풍" 검색 모멘텀(신규 키워드), hwadam 업장군 게이팅.
run_tb7_naver_ski.py와 동일한 저울(짝시드 5개·4폴드·raw/prod 동시 채점).

📌 사전등록 (experiments/log_tierb.md TB8 절, 결과 보기 전에 기록 — 2026-08-15)
...
CAND_KEYS = ["naver_hwadam_foliage_lag7_18_g"]
ARMS = [("L0 base(54)", []), (f"TB8 +naver_hwadam({54 + len(CAND_KEYS)})", CAND_KEYS)]
CANDIDATE = ARMS[1][0]
OUT = os.path.join(C.EXPERIMENTS, "phase_tb8_naver_hwadam.json")
